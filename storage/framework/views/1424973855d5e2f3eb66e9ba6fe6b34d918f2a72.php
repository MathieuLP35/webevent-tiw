                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <?php if(Auth::user()->id == $event->author_id): ?>
                                        <td class="px-6 py-4 text-right">
                                            ...
                                            <?php endif; ?>
                                            <a href="<?php echo e(url('event/'.$event->id.'/show')); ?>" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Voir</a>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\webevent\resources\views/pages/event/list.blade.php ENDPATH**/ ?>